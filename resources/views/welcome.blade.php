    ...
    <div class="container">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#menu"><img src="images/Logo/kirsch_small.jpg" alt=""width="100px" height ="45px"></a> </div>
        ...
        <div class="carousel-caption container">
          <div class="row">
            <div class="col-md-7 col-sm-12 col-xs-12">
              <h1>We Are KIRSCH</h1>
              <h2>Ensuring your promises</h2>
              <p>KIRSCH – A One Page Parallax, HTML5 and Responsive Template suitable for any creative business agency. Multiple pages also included in this theme with lots of CSS and JQuery animations</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="carousel-caption container">
          <div class="row">
            <div class="col-md-7 col-sm-12 col-xs-12">
              <h1>We Are KIRSCH</h1>
              <h2>Ensuring your promises</h2>
              <p> KIRSCH – A One Page Parallax, HTML5 and Responsive Template suitable for any creative business agency. Multiple pages layouts also in this theme with lots of CSS and JQuery animations</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="carousel-caption container">
          <div class="row">
             <div class="col-md-7 col-sm-12 col-xs-12">
              <h1>We Are KIRSCH</h1>
              <h2>Ensuring your promises</h2>
              <p> KIRSCH – A One Page Parallax, HTML5 and Responsive Template suitable for any creative business agency. Multiple page also included in this theme with lots of CSS and JQuery animations</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        ...
        <div class="line"></div>
        <p><span><strong>K</strong></span>irsch We empower people to transform complex data anywhere into actionable insights faster and easier.</p>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12 ab-sec">
        <div class="col-md-6">
          ...
          <p><span><strong>K</strong></span>irsch The team is composed of talented and diverse individuals that have their own specialization.  Banded together by their shared interest to provide solutions better than most offered in the market.  At Kirsch, we are not just developers, we are partners that help you move your business.</p>
        </div>
...
<div class="bg-sec">
  <div class="container">
    <div class="col-md-10 col-sm-10 col-xs-8">
      ...
      <p>In kirsch we provide a quality services please download our one sample of the qoutation </p>
    </div>
  ...
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        ...
        <div class="line"></div>
        <p><span><strong>K</strong></span>irsch services that brings your business to a new level.Our experts will guide you through your entire IT transformation, from strategy and consulting to managed services. Our consulting services form the foundation for long-lasting IT partnerships that can help you imagine and innovate in the digital world. We deliver best-of-breed technologies with a white-glove approach that provides maximum value for your business. iVision will create a roadmap from where you are to where you want to be, and then use rigorous assessments and consulting expertise to make it happen.
        </p>
      </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              ...
              <p>User experience (UX) design is the process design teams use to create products that provide meaningful and relevant experiences to users. UX design involves the design of the entire process of acquiring and integrating the product, including aspects of branding, design, usability and function</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              ...
              <p>Creates screens, buttons, toggles, icons, and other visual elements that you interact with when using a website, app, or other electronic device. UX refers to the entire interaction you have with a product, including how you feel about the interaction.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="200ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              ...
              <p>Marketing is the process of creating, delivering, promoting, and pricing products or services to customers.</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              ...
              <p>SEO (Search Engine Optimization) services are a set of techniques and strategies used to improve the visibility and ranking of a website or a web page in search engine results pages (SERPs).</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              ...
              <p>A solution designed to run on an Android device or emulator.  It is a file containing app code, resources, and meta information written from various programming languages and are run inside a Virtual Machine.</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="500ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              ...
              <p>A clean codebase is essential for long-term maintainability, readability and scalability. It also helps in reducing the time to fix bugs, add new features and make changes to the codebase. A clean codebase also enables multiple developers to work on the codebase efficiently and effectively.</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
    ...
    <div class="tab-content">
      <div role="tabpanel" class="tab-pane fade in active feat-sec" id="tab-1">
        <div class="col-md-6 tab">
          ...
          <p class="feat-sec">Web design refers to the process of creating a website's visual and structural layout, user interface, and user experience (UX). It encompasses a wide range of skills and disciplines, including graphic design, web development, user interface design, and search engine optimization (SEO). A well-designed website is visually appealing, easy to navigate, and optimized for search engines and user experience.<br>
          </p>
          <p class="feat-sec-1">A web designer typically works with a team of developers, graphic designers, and project managers to create a website that meets the client's needs and goals. They use a variety of tools such as Adobe Photoshop, Adobe Illustrator, and HTML/CSS to design and create the website layout, graphics and images. </p>
        </div>
      ...
      <div role="tabpanel" class="tab-pane fade feat-sec" id="tab-2">
        <div class="col-md-6 tab">
          ...
          <div class="line"></div>
          <div class="clearfix"></div>
          <p class="feat-sec">Graphic design is the process of creating visual content to communicate information or ideas. It involves the use of typography, photography, illustration, and color to create visual compositions that are both effective and aesthetically pleasing. Graphic design can be applied in various fields such as advertising, publishing, web design, packaging, and more.<br>
          </p>
          <p class="feat-sec-1">Graphic designers use a variety of tools such as Adobe Photoshop, Adobe Illustrator, InDesign, and Sketch to create designs for print and digital media. They work closely with art directors, writers, and other members of a creative team to develop visual solutions that meet the needs of the client or project.</p>
        </div>
      ...
      <div role="tabpanel" class="tab-pane fade feat-sec" id="tab-3">
        <div class="col-md-6 tab">
          ...
          <div class="line"></div>
          <div class="clearfix"></div>
          <p class="feat-sec">Web development is the process of creating, building and maintaining websites. It encompasses a wide range of tasks, including web design, web content development, client-side/server-side scripting, and network security configuration. It can be divided into two categories: front-end development and back-end development.<br>
          </p>
          <p class="feat-sec-1">Web development is an ever-evolving field as technologies, frameworks and methodologies are frequently updated and new ones are developed. Web developers need to keep themselves updated with the latest trends and technologies to deliver efficient and effective solutions.</p>
        </div>
      ...
      <div role="tabpanel" class="tab-pane fade feat-sec" id="tab-4">
        <div class="col-md-6 tab">
          ...
          <div class="line"></div>
          <div class="clearfix"></div>
          <p class="feat-sec">Responsive design is a web design approach that allows a website to adapt its layout and functionality to the size of the device or screen it is being viewed on. This enables the website to provide an optimal viewing experience for users, regardless of whether they are using a desktop computer, tablet, or smartphone.<br>
          </p>
          <p class="feat-sec-1">It is important for developers to test the website on different devices, screen sizes, and browsers to ensure that the responsive design is working as intended and that all users have an optimal experience.</p>
        </div>
      ...
      <div role="tabpanel" class="tab-pane fade feat-sec" id="tab-5">
        <div class="col-md-6 tab">
          ...
          <div class="line"></div>
          <div class="clearfix"></div>
          <p class="feat-sec">A creative gallery is a collection of visual or creative works that are displayed in a public or private space. This can include art galleries, photography galleries, and design galleries, among others. These works can include paintings, sculptures, photographs, digital art, and other forms of visual media.<br>
          </p>
          <p class="feat-sec-1">A creative gallery can be physical or digital, and it can be open to the public or by invitation only. Physical galleries are often located in art districts or cultural centers, while digital galleries can be found online.</p>
        </div>
  ...
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        <h2>AWESOME FEATUR<span>ES</span></h2>
        <div class="line"></div>
        <p><span><strong>K</strong></span>irsch Explore Kirchs features for integrating, analyzing, and taking action on your data.</p>
      </div>
    </div>
  ...
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        ...
        <div class="line"></div>
        <p><span><strong>K</strong></span>irsch Reach your digital marketing and Web development goals with help from Marketing Cloud experts.</p>
      </div>
    </div>
    <div class="row">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-3 col-sm-6 col-xs-12 team-main-sec wow slideInUp" data-wow-duration="1s" data-wow-delay=".1s">
        <div class="team-sec">
          <div class="team-img"> <img src="./images/Team/Bella.jpeg" class="img-responsive" alt="">
            <div class="team-desc">
              <h5>Kris</h5>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 team-main-sec wow slideInUp" data-wow-duration="1s" data-wow-delay=".2s">
        <div class="team-sec">
          <div class="team-img"> <img src="./images/Team/Chad.jpg" class="img-responsive" alt="">
            <div class="team-desc">
              <h5>Chad </h5>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
              <ul class="team-social-icon">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 team-main-sec wow slideInUp" data-wow-duration="1s" data-wow-delay=".3s">
        <div class="team-sec">
          <div class="team-img"> <img src="./images/Team/Mark.jpg" class="img-responsive" alt="">
            <div class="team-desc">
              <h5>Mark</h5>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
              <ul class="team-social-icon">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 team-main-sec wow slideInUp" data-wow-duration="1s" data-wow-delay=".4s">
        <div class="team-sec">
          <div class="team-img"> <img src="./images/Team/Sherwin.jpg" class="img-responsive" alt="">
            <div class="team-desc">
              <h5>Shen </h5>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
              <ul class="team-social-icon">
      ...
      <div class="col-md-6 col-sm-6 contact-sec-1">
        ...
        <ul class="contact-form">
          <li><i class="fa fa-map-marker"></i>
            <h6><strong>Address:</strong> Philppines Baguio City  </h6>
          </li>
          <li><i class="fa fa-envelope"></i>
            <h6><strong>Mail Us:</strong> <a href="#">bellaerikkirsch@gmail.com</a></h6>
          </li>
          <li><i class="fa fa-phone"></i>
            <h6><strong>Phone:</strong> +639876543210 </h6>
          </li>
          <li><i class="fa fa-wechat"></i>
           
            <h6>Website <a href="https://kirsch.com">Kirsch.com</a></h6>
...
<footer id="footer-down">
  ...
  <p> &copy; Copyright kirsch Studio Code- Created By : <a href="http://templatestock.co" target="_blank">Kirsch Development</a> </p>
</footer>
<!--Jquery-->
